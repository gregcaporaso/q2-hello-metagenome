...
from q2_hello_metagenome import __version__
from q2_hello_metagenome._methods import duplicate_table

citations = Citations.load("citations.bib", package="q2_hello_metagenome")

plugin = Plugin(
    name="hello-metagenome",
    version=__version__,
    website="https://example.com",
    package="q2_hello_metagenome",
